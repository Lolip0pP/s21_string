...
int main(void) {
  int failed = 0;
  Suite* tests[] = {s21_strlen_test(),  s21_memchr_test(),  s21_memcmp_test(),
                    s21_memcpy_test(),  s21_memset_test(),  s21_strncpy_test(),
                    s21_strncat_test(), s21_strchr_test(),  s21_strncmp_test(),
